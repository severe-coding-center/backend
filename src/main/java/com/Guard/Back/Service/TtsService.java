...
public class TtsService {
    ...
    // application.properties에서 AI TTS 서버 주소를 주입
    @Value("${ai.tts.server.url}")
    private String ttsServerUrl;

    /**
     * 텍스트를 AI 서버로 보내 MP3 음성 파일(byte 배열)로 변환
